      ...
      <Layout>
        <div className="relative">
          <img
            ...
            alt=""
          />
          <div className="relative bg-opacity-[0.85] bg-[#081a55]">
            <svg
                  ...
                  <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                    ...
                    <form onSubmit={(e) => handleFormDataSubmit(e)}>
                      ...
                      <div className="mt-4 mb-2 sm:mb-4">
                        <button
                          type="submit"
                          className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-[#1b658e]  focus:shadow-outline focus:outline-none"
                        >
                          Subscribe
                        </button>
                      </div>
