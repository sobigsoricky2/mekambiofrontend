  ...
  <section className="features-section-three rel z-1 pt-110  pb-50 rpt-85 rpb-70">
    <div className="container">
      <div className="section-title text-center mb-55">
        <span className="sub-title-two">Las áreas en las que focalizarte </span>
        ...
        <p>
          ...
          evolucionas, o prefieres un cambio o acceder al mercado laboral, serán
          múltiples los beneficios que obtendrás si trabajas para cambiar tu
          situación.{" "}
        </p>
      </div>
      <div className="row justify-content-center">
        <div className="col-lg-4 col-sm-6">
          ...
          >
            ...
            <p>
              Los mejores atletas, tienen un gran equipo detrás. Queremos ser el
              tuyo.
            </p>
            <a href="#sec-1" className="details-btn">
              <i className="fas fa-long-arrow-alt-right" target="_blank" />
            </a>
          </div>
        </div>
        <div className="col-lg-4 col-sm-6">
          ...
          >
            ...
            <p>
              ¿Quieres cambiar el rumbo? Te ayudamos para que llegues al puerto
              que tu decidas.
            </p>
            <a href="#sec-2" className="details-btn">
        ...
        <div className="col-lg-4 col-sm-6">
          ...
          >
            ...
            <p>
              Si quieres empezar tu propia aventura, podemos acompañarte en el
              camino.
            </p>
            <a href="#sec-5" className="details-btn">
              <i className="fas fa-long-arrow-alt-right" />
            </a>
          </div>
        </div>
        <div className="col-lg-4 col-sm-6">
          ...
          >
            ...
            <a href="#sec-3" className="details-btn">
              <i className="fas fa-long-arrow-alt-right" />
            </a>
          </div>
        </div>
        <div className="col-lg-4 col-sm-6">
          ...
          >
            ...
            <p>
              Accede al mercado laboral a lo grande, de la mano de los mejores
              profesionales.{" "}
            </p>
            <a href="#sec-4" className="details-btn">
              <i className="fas fa-long-arrow-alt-right" />
            </a>
          </div>
        </div>
        <div className="col-lg-4 col-sm-6">
          ...
          >
            ...
            <p>
              Ponte al día para volver al mercado laboral de forma competitiva.{" "}
            </p>
            <a href="#sec-6" className="details-btn">
              <i className="fas fa-long-arrow-alt-right" />
            </a>
          </div>
        </div>
            ...
            <ul className="list-style-three pt-10">
              <li>
                <div className="content">
                  ...
                  <p>
                    Evoluciona profesionalmente, asciende y promociona a los
                    puestos que deseas.
                  </p>
                </div>
              </li>
              ...
              <li>
                <div className="content">
                  ...
                  <p>
                    Aprende a disfrutar con lo que haces e invierte en mejorar
                    en lo que se te da bien.
                  </p>
                </div>
              </li>
            </ul>
            ...
            <ul className="list-style-three pt-25 pb-20">
              <li>
                <div className="content">
                  ...
                  <p>
                    No renuncies a tus sueños, y trabaja para conseguirlos.
                    Nosotros te ayudamos a acercarte a ellos.
                  </p>
                </div>
              </li>
              <li>
                <div className="content">
                  ...
                  <p>
                    ...
                    remoto, en otras industrias, etc. Tú decides, y nosotros te
            ...
            <ul className="list-style-three pt-10">
              <li>
                <div className="content">
                  ...
                  <p>
                    Expande tu red de contactos a nivel internacional. Apende a
                    desarrollar y cultivar tu red de contactos.
                  </p>
                </div>
              </li>
              <li>
                <div className="content">
                  ...
                  <p>
                    ...
                    conocimiento internacional de nuestros Experts e impulsa tu
                    carrera.
                  </p>
                </div>
              </li>
              <li>
                <div className="content">
                  ...
                  <p>
                    ...
                    culturas y formas de hacer. Crecerás como profesional y
                    persona.
                  </p>
                </div>
              </li>
            ...
            <ul className="list-style-three pt-25 pb-20">
              <li>
                <div className="content">
                  ...
                  <p>
                    Iníciate en tu profesión con un plan de carrea definido en
                    exclusiva para ti.
                  </p>
                </div>
              </li>
            ...
            <ul className="list-style-three pt-10">
              <li>
                <div className="content">
                  <h5>Gran Impacto</h5>
                  <p>
                    Maximiza el impacto de tu nueva aventura de la mano del
                    equipo que te ayudará a despegar.
                  </p>
                </div>
              </li>
              <li>
                <div className="content">
                  ...
                  <p>
                    Conecta con el equipo que te ayudará a gestionar la parte
                    emocional de empezar tu nuevo negocio.
                  </p>
                </div>
              </li>
              <li>
    ...
    <div className="container">
      <div className="row align-items-center large-gap">
        ...
        <div className="col-lg-6">
          ...
          >
            <div className="section-title mb-20">
              <span className="sub-title-two">Regreso al Mercado Laboral</span>
            ...
            <ul className="list-style-three pt-25 pb-20">
              <li>
                <div className="content">
                  ...
                  <p>
                    Aprende las técnicas que te harán conseguir el trabajo que
                    tú desees.
                  </p>
                </div>
              </li>
