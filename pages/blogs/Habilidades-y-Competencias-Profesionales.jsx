...
const HabilidadesyCompetenciasProfesionales = () => {
    ...
    return (
      <Layout>
        <Banner
          title="Habilidades y Competencias Profesionales"
                ...
                <div className="blog-sidebar rmt-75">
                  ...
                  >
                    ...
                    <ul>
                      ...
                      <li>
                        <Link href="blog ">HabilidadesyCompetenciasProfesionales </Link> <span>(07)</span>
                      </li>
                      <li>
...
export default HabilidadesyCompetenciasProfesionales