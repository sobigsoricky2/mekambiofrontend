...
const EmpezandoentuCarreraProfesional = () => {
    ...
    return (
      <Layout>
        <Banner
          title="Empezando en tu Carrera Profesional"
                ...
                <div className="blog-sidebar rmt-75">
                  ...
                  >
                    ...
                    <ul>
                      ...
                      <li>
                        <Link href="blog ">EmpezandoentuCarreraProfesional </Link> <span>(07)</span>
                      </li>
                      <li>
...
export default EmpezandoentuCarreraProfesional