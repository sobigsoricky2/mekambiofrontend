...
const RegresoalMercadoLaboral = () => {
    ...
    return (
      <Layout>
        <Banner
          title="Regreso al Mercado Laboral"
                ...
                <div className="blog-sidebar rmt-75">
                  ...
                  >
                    ...
                    <ul>
                      ...
                      <li>
                        <Link href="blog ">RegresoalMercadoLaboral </Link> <span>(07)</span>
                      </li>
                      <li>
...
export default RegresoalMercadoLaboral