      ...
      <div className="row align-items-center large-gap">
        <div className="col-lg-6">
          ...
          >
            ...
            <p>
              No hay nada más poderoso que trabajar con los mejores, aprender de
              ellos y beneficiarse de su apoyo y guía. Te ofrecemos hacerlo en
              un entorno donde profesionales que buscan prosperar en la carrera
              que deseen pueden lograr dicho objetivo con el apoyo de otros que
              ya destacan en ello.
            </p>
            <ul className="list-style-three pt-25 pb-20">
              <li>
                <div className="content">
                  ...
                  <p>
                    No importa donde estés. Tendrás 100% acceso a todos los
                    Servicios.
                  </p>
                </div>
              </li>
              <li>
                <div className="content">
                  ...
                  <p>
                    Recibe apoyo y guía de profesionales senior, con una gran
              ...
              <li>
                <div className="content">
                  ...
                  <p>Conseguirás que eso con lo que sueñas se haga realidad.</p>
                </div>
              </li>
              <li>
                <div className="content">
                  <h5>Evoluciona Profesionalmente</h5>
                  <p>Evita el estancamiento, y progresa en tu profesión.</p>
                </div>
              </li>
            </ul>
            <Link
          ...
          >
            <div className="work-step-item">
              ...
              <div className="content">
                ...
                <p>
                  Focaliza en tu área, y encuentra al Expert que mejor se adapte
            ...
            <div className="work-step-item">
              ...
              <div className="content">
                ...
                <p>
                  Elige fecha y hora, y comprométete contigo y tu futuro para
                  evolucionar en tu carrera profesional.
                </p>
              </div>
            </div>
            <div className="work-step-item">
            ...
            <div className="work-step-item">
              ...
              <div className="content">
                ...
                <p>
                  Inicia y disfruta de tu evolución profesional, mejorando tu
                  rendimiento y dedicándote a lo que te apasiona.
                </p>
              </div>
            </div>
          </div>
