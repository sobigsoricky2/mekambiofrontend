...
export default async function googlesheetsFormData(req, res) {
  try {
    if (req.method != "POST") {
    ...
    const auth = new google.auth.GoogleAuth({
      credentials: {
        client_email: "spreadsheet@subsribersdata.iam.gserviceaccount.com",
        private_key:
    ...
    const response = await sheets.spreadsheets.values.append({
      spreadsheetId: "1LTSMPoYnLmGqhR6F5CXmhSk9-LlmbQioO617JRUZYpM",
      range: "Sheet2!A:D",
