...
const AboutUs = () => {
      ...
      <div className="row align-items-center large-gap">
        <div className="col-lg-5">
          <div className="about-page-content wow fadeInLeft delay-0-2s">
            ...
            <p>
              En 2020 se sembró la semilla de una idea; un proyecto de apoyo a
              profesionales con apuros en sus carreras.{"{"}" "{"}"}
            </p>
          </div>
        </div>
          ...
          <div className="about-page-content wow fadeInLeft delay-0-2s">
            <div className="section-title mb-30">
              ...
              <h2 style={{ fontSize: 31 }}>
                Ayudar a profesionales a mejorar su rendimiento, liderando sus
                carreras profesionales a través del cambio y la transformación
                interior.
              </h2>
            </div>
            <p>
              meKambio es ahora un proyecto focalizado en facilitar el
              desarrollo y la evolución profesional a toda persona que desee
              mejorar su futuro. Nos apasiona generar el cambio y la
              transformación profesional de personas dispuestas a liderar sus
              propias carreras dando así forma a su futuro, a la vez que
              apoyando a otras a que hagan lo mismo.
            </p>
          </div>
        </div>
        <div className="col-lg-2">
          <div className="counter-wrap style-two wow fadeInRight delay-0-4s">
            ...
            <div className="success-item">
              <span className="count-text" data-speed={3000} data-stop={365}>
                0
              </span>
              <span>Días</span>
            </div>
  ...
  <section className="team-setion-two bg-lighter rel z-1 pt-120 rpt-90 pb-70 rpb-40">
    <div className="container">
      ...
      <div className="row justify-content-center">
        ...
        <div className="col-lg-3 col-md-4 col-sm-6">
          <div className="team-member-two wow fadeInUp delay-0-4s">
            <div className="image">
              <img src="/assets/images/teams/Stephen.png" alt="Team Member" />
              {"{"}/*{" "}
              {/* <div class="social-style-two">
                              <a href="contact.html"><i class="fab fa-twitter"></i></a>
                              <a href="contact.html"><i class="fab fa-facebook-f"></i></a>
      ...
      <a href="https://www.meKambio.com/s?q=" className="theme-btn float-right">
        ...
        <div className="col-lg-6 text-white">
          ...
          >
            <div className="content">
              ...
              <p>
                Accede a la base de profesionales que pueden ayudarte a impulsar
                tu carrera
              </p>
              <a href="https://experts.mekambio.com/s?q=" className="theme-btn">
        ...
        <div className="col-lg-6">
          ...
          >
            <div className="content">
              ...
              <p>
                Regístrate como Expert y ayuda a profesionales a progresar en
                sus carreras
              </p>
              <a
