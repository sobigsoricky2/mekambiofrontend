  ...
  (t.prototype = {
    ...
    _close: function () {
      ...
      d.off("keyup" + p + " focusin" + p),
        b.ev.off(p),
        b.wrap.attr("className", "mfp-wrap").removeAttr("style"),
        b.bgOverlay.attr("className", "mfp-bg"),
        b.container.attr("className", "mfp-container"),
        !b.st.showCloseBtn ||
              ...
              "replaceWith" === g
                ...
                ? f.is("img")
                  ...
                  : f.replaceWith(
                      a("<img>")
                        .attr("src", d)
                        .attr("className", f.attr("className"))
                    )
                : f.attr(e[1], d);
            }
